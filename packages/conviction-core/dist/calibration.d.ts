 ...
 */
export declare function brierScore(forecasts: ProbabilityForecast[]): number | null;
/**
 ...
 * resolved.
 */
export declare function logLoss(forecasts: ProbabilityForecast[]): number | null;
/**
 ...
 */
export declare function hitRate(forecasts: ProbabilityForecast[]): number | null;
/**
 ...
 */
export declare function reliabilityBuckets(forecasts: ProbabilityForecast[]): ReliabilityBucket[];
/**
 ...
 */
export declare function calculateCalibrationMetrics(forecasts: ProbabilityForecast[]): CalibrationMetrics;
