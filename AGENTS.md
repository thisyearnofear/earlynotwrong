...
> Last updated: 2026-08-19. Live commit on `nuncio-vultr`: `670a424e` (err.toString() MarketNotOpen detection). **Agent trading live on 3 Delphi positions** (~263 TST deployed, bankroll 671 TST spent, 931.95 TST recovered): UAP records (fc 0.85 @ 0.56, resolves 08-21), Treasury 10Y (fc 0.50 @ 0.32, resolves 08-20), Botafogo 4+ goals (fc 0.65 @ 0.28, resolves 08-20). Bankroll recovered after stale-subgraph guard + MarketNotOpen detection released ~92.5 TST pinned in the settled Chess-Wikipedia market. Endgame sizing loosened (`maxPositionFraction` 0.15, `maxMarketFraction` 0.35) and forecaster temperature raised to 0.35 to counter ensemble overconfidence.
