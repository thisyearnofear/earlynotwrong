...
> Last updated: 2026-08-15. Live commit on `nuncio-vultr`: `92ba12a8` (inference ladder fully free-tier redundant). **Agent trading live on 3 positions** (~271 TST deployed, 786 TST bankroll): Typhoon Dolphin YES (fc 0.95 @ 0.317), Trump Senate nominations (fc 0.95), Chess Wikipedia pageviews (fc 0.85 @ 0.666 — entered by the new hf-qwen tier). Estimates recovered to 14/15 per cycle after both quota-limited sources ran dry.
