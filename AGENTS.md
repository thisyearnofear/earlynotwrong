...
> Last updated: 2026-08-14. Live commit on `nuncio-vultr`: `9e8da4fe` (inference cost + efficiency hardening — forecast cache, promo expiry guard, 429 backoff, free-model pinning; Delphi runner live on competition-testnet, hourly cycles).
