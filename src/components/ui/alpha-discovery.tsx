...
export function AlphaDiscovery({ className }: AlphaDiscoveryProps) {
    ...
    const getRatingIcon = (rating: string) => {
        switch (rating) {
            ...
            case 'High': return <Zap className="w-4 h-4 text-signal" />;
            case 'Medium': return <Target className="w-4 h-4 text-foreground" />;
            default: return <Users className="w-4 h-4 text-foreground-muted" />;
        }
    };
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => setFilters(prev => ({ ...prev, chain: prev.chain === 'solana' ? 'base' : prev.chain === 'base' ? null : 'solana' }))}
                            ...
                            wallets.map((wallet) => (
                                ...
                                >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-1">
                                                <span className="font-mono text-sm text-foreground">
                                                    {wallet.farcasterIdentity?.displayName || formatAddress(wallet.address)}
                                                </span>
                                                ...
                                                <span className={cn(
                                                    ...
                                                    wallet.chain === 'solana' ? "bg-purple-500/20 text-purple-300" : "bg-blue-500/20 text-blue-300"
                                                )}>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <ConvictionBadge
                                            archetype={wallet.archetype as any}
                                            size="sm"
                                        />
